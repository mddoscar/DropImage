...
@implementation UIView (MddDraggle)
//@synthesize DraggableEndCallBack=_DraggableEndCallBack;
- (void)makeDraggable
{
...
- (void)zy_panGesture:(UIPanGestureRecognizer *)pan
{
             ...
             pan.state == UIGestureRecognizerStateFailed)
    {
        ...
        //执行回掉
        //if (self.DraggableEndCallBack!=nil) {
        //    self.DraggableEndCallBack(self);
        //}
        NSMutableDictionary * tDic=[NSMutableDictionary dictionary];
        [tDic setObject:self forKey:kCallBackNotiView];
        [tDic setObject:pan forKey:kCallBackNotiGesture];
        [[NSNotificationCenter defaultCenter] postNotificationName:kCallBackNoti object:tDic userInfo:nil];
    }
}
...
//{
    //static UIView *sharedAccountManagerInstance = nil;
    //static dispatch_once_t predicate;
    //dispatch_once(&predicate, ^{
//        self.DraggableEndCallBack=pEndCallBack;
    //});      //__weak UIView *weakSelf = self;
     //weakSelf.DraggableEndCallBack=pEndCallBack;
//}
//-(void) setDraggableEndCallBack:(void (^)(UIView *))DraggableEndCallBack
//{
    //__weak UIView *weakSelf = self;
    // weakSelf.DraggableEndCallBack=DraggableEndCallBack;
//}
@end
